/**
 * @remarks Tracked readme explaining generated `public/` behavior.
 */
const PUBLIC_DIRECTORY_README_FILENAME = "README.md"

/**
 * @remarks Files always preserved during clean syncs.
 */
const PUBLIC_DIRECTORY_KEEP_FILES = [
    ".gitkeep",
    PUBLIC_DIRECTORY_README_FILENAME
] as const

/**
 * @remarks Default readme copy written when the file is missing.
 */
const PUBLIC_DIRECTORY_README_CONTENT = `# Generated public directory
